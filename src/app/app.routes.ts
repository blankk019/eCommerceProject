  ...
  // 🔹 Main layout routes (lazy loaded)
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () =>
          import(
            './features/brands/brand-product/brand-product.component'
          ).then((m) => m.BrandProductComponent),
      },

      {
        ...
        children: [
          { path: '', redirectTo: 'address', pathMatch: 'full' },
          {
            ...
            loadComponent: () =>
              import(
                './features/checkout/components/address/address.component'
          ...
          },
          {
            ...
            loadComponent: () =>
              import(
                './features/checkout/components/shipping/shipping.component'
      ...
      },
      {
        path: 'allorders',
        loadComponent: () =>
          import('./features/receipt/receipt.component').then(
